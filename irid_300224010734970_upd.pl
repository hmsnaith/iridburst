#!/usr/bin/perl
#irid_300224010734970_upd.pl
#Run from iridium.pl, printf $data | perl irid_300224010734970_upd.pl
#where $data hold decoded email data
#Outputs data to local raw and data files as well as adding to database
...
print "Running irid_300224010734970_upd\n";
