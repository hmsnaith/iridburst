...
if ($data =~ m/5207001e4525d6a2,1,DAS_2C/)   # for 2016 messages
    {
    ($WMAN,$data_date,$data_time,$WMAN_sn,$mess_no,$sys_id,$lat0,$lon0,$wind_speed,$wind_dir,$wind_gust,    $sea_temp, $air_temp, $humidity, $dew_temp,  $air_press, $Hsig, $Hmax, $wave_TP, $wave_dir, $last)=split(/,/,$data,24);
...
#			$sqlupd.="air_temp_2='".$air_temp_2."',";  mred 20160421
